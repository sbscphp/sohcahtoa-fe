...
import { isDepositVerified } from "@/app/(customer)/_utils/deposit-verified";
...
/** Customer: poll deposit status after “I have sent the money”. */
export function useDepositConfirmationPoll({
  transactionId,
  opened,
  confirmingPayment,
  pollStartedAtRef,
