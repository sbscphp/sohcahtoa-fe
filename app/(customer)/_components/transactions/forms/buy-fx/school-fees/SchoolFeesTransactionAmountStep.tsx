...
const MAX_SCHOOL_FEES_AMOUNT = 10_000;
...
interface SchoolFeesTransactionAmountStepProps {
  initialValues?: Partial<SchoolFeesTransactionAmountFormData>;
  onSubmit: (data: SchoolFeesTransactionAmountFormData) => void;
  onBack?: () => void;
  exchangeRate?: string;
}

export default function SchoolFeesTransactionAmountStep({
  initialValues,
  onSubmit,
  onBack,
          ...
          <CurrencyAmountInput
            ...
            onChange={(value) => {
              ...
              if (receiveAmountOverMax(value)) {
                form.setFieldError(
                  "receiveAmount",
                  receiveAmountExceedsMaxMessage(MAX_SCHOOL_FEES_AMOUNT)
                );
              } else {
