...
export type ProfessionalBodyBankDetailsFormData = z.infer<typeof bankDetailsSchema>;
...
interface ProfessionalBodyBankDetailsStepProps {
  initialValues?: Partial<ProfessionalBodyBankDetailsFormData>;
...
export default function ProfessionalBodyBankDetailsStep({
  ...
  onSubmit,
  onBack,
}: ProfessionalBodyBankDetailsStepProps) {
