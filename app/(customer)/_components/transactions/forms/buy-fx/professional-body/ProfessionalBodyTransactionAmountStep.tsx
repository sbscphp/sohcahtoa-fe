...
interface ProfessionalBodyTransactionAmountStepProps {
  initialValues?: Partial<ProfessionalBodyTransactionAmountFormData>;
  onSubmit: (data: ProfessionalBodyTransactionAmountFormData) => void;
  onBack?: () => void;
  exchangeRate?: string;
}

export default function ProfessionalBodyTransactionAmountStep({
  initialValues,
  onSubmit,
  onBack,
