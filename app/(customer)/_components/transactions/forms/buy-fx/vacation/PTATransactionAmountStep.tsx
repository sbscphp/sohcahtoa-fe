...
interface PTATransactionAmountStepProps {
  initialValues?: Partial<TransactionAmountFormData>;
  onSubmit: (data: TransactionAmountFormData) => void;
  onBack?: () => void;
  exchangeRate?: string;
}

export default function PTATransactionAmountStep({
  initialValues,
  onSubmit,
  onBack,
