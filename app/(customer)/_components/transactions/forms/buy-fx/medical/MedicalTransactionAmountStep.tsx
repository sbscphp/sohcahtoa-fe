...
interface MedicalTransactionAmountStepProps {
  initialValues?: Partial<MedicalTransactionAmountFormData>;
  onSubmit: (data: MedicalTransactionAmountFormData) => void;
  onBack?: () => void;
  exchangeRate?: string;
}

export default function MedicalTransactionAmountStep({
  initialValues,
  onSubmit,
  onBack,
  exchangeRate = "USD1 - NGN1500",
}: MedicalTransactionAmountStepProps) {
  const [proofModalOpen, setProofModalOpen] = useState(false);
  const form = useForm<MedicalTransactionAmountFormData>({
    mode: "uncontrolled",
    initialValues: {
