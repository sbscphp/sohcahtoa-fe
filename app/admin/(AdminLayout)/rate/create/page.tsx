...
export default function CreateRatePage() {
  ...
  const createRateMutation = useCreateData(adminApi.rate.create, {
    onSuccess: (response) => {
      ...
      notifications.show({
        ...
        message:
          ...
          "A new currency rate has been successfully created.",
        color: "green",
      });
    ...
    onError: (error) => {
      ...
      notifications.show({
        title: "Create Rate Failed",
        message:
          apiResponse?.error?.message ??
          error.message ??
          "Unable to create this rate at the moment. Please try again.",
        color: "red",
      });
    },
  });
  ...
  const handleConfirmCreate = () => {
    ...
    const payload = buildCreateRatePayload(form.values);
    if (!payload) {
      notifications.show({
