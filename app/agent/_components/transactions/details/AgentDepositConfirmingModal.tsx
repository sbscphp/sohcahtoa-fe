...
type AgentDepositConfirmingModalProps = {
  opened: boolean;
  confirmTimedOut: boolean;
  onClose: () => void;
};

/** Agent: overlay while bank payment is being confirmed. */
export function AgentDepositConfirmingModal({
  opened,
  confirmTimedOut,
  onClose,
}: Readonly<AgentDepositConfirmingModalProps>) {
  return (
    <Modal
      opened={opened}
      onClose={() => {}}
